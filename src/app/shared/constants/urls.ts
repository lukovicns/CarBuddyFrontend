...
export const messagesUrl = (recipientId: string, conversationId: string, pageNumber = 1) => `${apiUrl}/messages/${recipientId}/conversation/${conversationId}?pageNumber=${pageNumber}&pageSize=10`;
